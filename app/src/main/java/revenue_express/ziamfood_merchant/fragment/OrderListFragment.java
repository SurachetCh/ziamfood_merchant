...
import revenue_express.ziamfood_merchant.adapter.OrderListAdapter;
...
public class OrderListFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        myFragmentView = inflater.inflate(R.layout.fragment_order_list, container, false);
//        URL_list_order = getResources().getString(R.string.Base_URL)+getResources().getString(R.string.URL_list_order);
...
//        callSyncListOrder(URL_list_order);
        callListOrder();
    ...
    private void setrecycler(){
        OrderListAdapter adapter = new OrderListAdapter(getActivity(),list_order);
...
//    private void callSyncListOrder(final String url) {
...
//
//                System.out.println("Url ListOrder:"+url.toString());
//
...
//                                    Log.i("ListOrder Result: ",jsonData.toString());
//                                }
//
//                                getActivity().runOnUiThread(new Runnable() {
//                                    @Override
...
//    }
    ...
    private void callListOrder(){
        ...
        api.getOrderList(getResources().getString(R.string.access_token),shop_id,"main").enqueue(new retrofit2.Callback<ResponseBody>() {
            @Override
